...
## Fase de UX - Botões de Fechar em Modais

- [x] Criar componente ModalHeader com botão de fechar
- [x] Adicionar botão de fechar em settings
- [x] Adicionar botão de fechar em settings-printer
- [x] Adicionar botão de fechar em create-label
- [x] Adicionar botão de fechar em label-details
- [x] Testar navegação de volta em todas as modais
- [x] Validar UX em mobile e desktop
